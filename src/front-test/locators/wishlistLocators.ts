...
export const productInWishlist = 'Product 3';
export const removeFromWishlistButton = '';
export const wishlistButtonOnProductPage = '//*[@id="image-gallery-216811"]/div[1]/button/i[2]';
export const wishlistPopupLink = 'Wish List (1) ';